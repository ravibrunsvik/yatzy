...
function turnManager() {
  ...
  function sacrificeSpace(e) {
    ...
    if (
      e.target.classList.contains("sacrifice-field") &&
      !e.target.classList.contains("sum") &&
...
function checkForBonus(gameboard, id) {
  ...
  const one = gameboard[1] ? parseInt(gameboard[1]) : 0,
    two = gameboard[2] ? parseInt(gameboard[2]) : 0,
    three = gameboard[3] ? parseInt(gameboard[3]) : 0,
    four = gameboard[4] ? parseInt(gameboard[4]) : 0,
    five = gameboard[5] ? parseInt(gameboard[5]) : 0,
    six = gameboard[6] ? parseInt(gameboard[6]) : 0;
